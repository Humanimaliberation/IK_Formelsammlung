...
\sectionbox{
	\subsection{Blockparität}
	Beispiel Blockparität mit 9 Nutzdaten und insgesamt 7 Paritätsbits. Die Nummerierung der Bits erfolgt in Sendereihenfolge.\\

	\includegraphics[width = 6cm]{./img/Blockparitaet.png}
